...
import com.example.nogs.ui.entities.dummy.DummyContent.DummyItem;
...
public class MyEntitiesRecyclerViewAdapter extends RecyclerView.Adapter<MyEntitiesRecyclerViewAdapter.ViewHolder> {
    ...
    public MyEntitiesRecyclerViewAdapter(List<DummyItem> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_donate, parent, false);
